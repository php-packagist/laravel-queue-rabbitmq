...
namespace PhpPackagist\LaravelQueueRabbitMQ\Queue\Connectors;
...
use PhpPackagist\LaravelQueueRabbitMQ\Horizon\Listeners\RabbitMQFailedEvent;
use PhpPackagist\LaravelQueueRabbitMQ\Horizon\RabbitMQQueue as HorizonRabbitMQQueue;
use PhpPackagist\LaravelQueueRabbitMQ\Queue\RabbitMQQueue;
...
class RabbitMQConnector implements ConnectorInterface
{
     ...
     */
    protected function createQueue(string $worker, AbstractConnection $connection, string $queue, array $options = []): RabbitMQQueue|Queue|HorizonRabbitMQQueue
    {
        return match ($worker) {
